...
export const createPin = async (data) => {
  ...
  const newPin = {
    ...
    latitude: typeof data.latitude === 'string' ? parseFloat(data.latitude) : (data.latitude || 20.5937),
    longitude: typeof data.longitude === 'string' ? parseFloat(data.longitude) : (data.longitude || 78.9629),
